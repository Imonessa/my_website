...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Профиль - Cybersecurity Learning Platform</title>
    <link rel="stylesheet" href="styles.css">
</head>
<body class="<?php echo $category; ?>">
    ...
    <header>
        ...
        <p>
            <?php
            if ($category === 'student') echo 'Твой путь кибер-ниндзя начинается здесь!';
            elseif ($category === 'college') echo 'Следи за своим прогрессом';
            elseif ($category === 'pro') echo 'Управляй своими достижениями';
            else echo 'Выбери категорию, чтобы увидеть свой профиль';
            ?>
        </p>
    ...
    <div class="section" id="profile">
        <h2>Профиль</h2>
        <p>Раздел в разработке. Скоро здесь будет твой личный кабинет!</p>
    </div>
</body>
</html>