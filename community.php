...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Сообщество - Cybersecurity Learning Platform</title>
    <link rel="stylesheet" href="styles.css">
</head>
<body class="<?php echo $category; ?>">
    ...
    <header>
        ...
        <p>
            <?php
            if ($category === 'student') echo 'Общайся с другими кибер-ниндзя!';
            elseif ($category === 'college') echo 'Делись опытом и учись у других';
            elseif ($category === 'pro') echo 'Сеть экспертов кибербезопасности';
            else echo 'Выбери категорию, чтобы присоединиться к сообществу';
            ?>
        </p>
    ...
    <div class="section" id="community">
        <h2>Сообщество</h2>
        <p>Скоро здесь будет место для общения и обмена опытом!</p>
    </div>
</body>
</html>