...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Библиотека - Cybersecurity Learning Platform</title>
    <link rel="stylesheet" href="styles.css">
</head>
<body class="<?php echo $category; ?>">
    ...
    <header>
        ...
        <p>
            <?php
            if ($category === 'student') echo 'Полезные материалы для начала!';
            elseif ($category === 'college') echo 'Ресурсы для твоего обучения';
            elseif ($category === 'pro') echo 'Инструменты и гайды для профи';
            else echo 'Выбери категорию, чтобы получить материалы';
            ?>
        </p>
